  ...
  return (
    <main className="page">
      ...
      <section className="card">
        <p className="eyebrow">Desktop YouTube First</p>
        <h1>YouTube para MP4/MP3 com backend + fallback local</h1>
        <p className="subtitle">No desktop, links do YouTube usam backend com progresso real. Fallback local/WASM permanece.</p>
